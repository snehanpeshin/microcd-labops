...
import { Activity, BarChart3, BookOpenCheck, Boxes, Braces, Building2, ChevronDown, ClipboardCheck, Compass, FileCheck2, FileText, FileUp, FlaskConical, FolderKanban, Gauge, GitBranch, ListTodo, Microscope, PackageSearch, Search, Settings, Sparkles, TestTube2, Warehouse } from "lucide-react";
