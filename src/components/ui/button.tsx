...
const variants = {
  primary: "bg-teal-700 text-white shadow-sm shadow-teal-950/15 hover:bg-teal-800 hover:shadow-md hover:shadow-teal-950/15 focus-visible:outline-teal-700",
  secondary: "border border-slate-300 bg-white text-slate-900 shadow-sm hover:border-slate-400 hover:bg-slate-50 hover:shadow focus-visible:outline-slate-600",
