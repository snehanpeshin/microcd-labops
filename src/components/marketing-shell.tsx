...
export function MarketingHeader() {
  return <><div className="utility-bar"><span>Laboratory operations for scientific hardware teams</span><a href="https://www.microcdlabs.com" target="_blank" rel="noreferrer">MicroCD Labs <ExternalLink size={12} /></a></div><header className="marketing-header"><div className="marketing-header-inner"><Brand /><nav aria-label="Marketing navigation" className="marketing-nav"><Link href="/product-tour">Product tour</Link><Link href="/features/reports">Reports</Link><Link href="/features/traceability">Traceability</Link><Link href="/pricing">Pricing</Link><Link href="/security">Security</Link></nav><div className="marketing-actions"><ButtonLink href="/login" variant="ghost" className="hidden sm:inline-flex">Log in</ButtonLink><ButtonLink href="/request-demo">Discuss a pilot</ButtonLink><details className="mobile-menu"><summary aria-label="Open navigation"><Menu size={20} /></summary><nav aria-label="Mobile navigation"><Link href="/product-tour">Product tour</Link><Link href="/features/reports">Reports</Link><Link href="/features/traceability">Traceability</Link><Link href="/pricing">Pricing</Link><Link href="/security">Security</Link><Link href="/request-demo">Discuss a pilot</Link><Link href="/login">Log in</Link></nav></details></div></div></header></>;
}
