...
export type QualityDocumentStatus="draft"|"in_review"|"changes_requested"|"approved"|"obsolete";
export interface QualityDocumentRevision {id:string;revision:number;content:string;source:"template"|"user"|"ai_assisted";aiMetadata:Record<string,unknown>;dlpSummary:Record<string,unknown>;createdBy:string;createdAt:string;}
